...
class SubjectTextField extends StatefulWidget
{
  ...
  SubjectTextField({super.key, required this.textController, required this.hintText, required this.maxLines, required this.inputType, required this.filteringTextInputFromatter});
